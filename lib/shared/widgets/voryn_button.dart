...
class _VorynButtonState extends State<VorynButton> {
  ...
  Widget build(BuildContext context) {
    ...
    final background = switch ((isPrimary, widget.isDisabled, _pressed)) {
      (true, true, _) => colors.disabled,
      (true, false, true) => colors.accentViolet,
      (true, false, false) => colors.accent,
      (false, true, _) => colors.surface,
      (false, false, true) => colors.surfacePressed,
      (false, false, false) => colors.surfaceRaised,
    };
